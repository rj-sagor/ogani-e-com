         ...
         <form action="{{url('admin/update/product',$product->id)}}" method="post" >
          ...
          @if(session('succes'))
            ...
            <div class="row mg-b-25">
             ...
             <input type="hidden" name="img_first" value="{{$product->image_one}}">
             <input type="hidden" name="img_secend" value="{{$product->image_two}}">
             <input type="hidden" name="img_third" value="{{$product->image_three}}">
